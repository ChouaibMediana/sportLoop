...
class Biographyn_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'biographyn';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'biographyn' ), $i ),
...
// Initialize.
$biographyn_footer_widgets = new Biographyn_Footer_Widgets();
