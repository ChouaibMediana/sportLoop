...
/* Breadcrumb Begin */
function vw_fitness_gym_the_breadcrumb() {
	if (!is_home()) {
		echo '<a href="';
...
function vw_fitness_gym_activation_notice() {
	...
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span class="demo-btn"><a href="'. esc_url( 'https://demos.buywptemplates.com/fitness-gym-pro/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'VIEW DEMO', 'vw-fitness-gym' ) .'</a></span>';
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.buywptemplates.com/products/fitness-gym-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-fitness-gym' ) .'</a></span>';
		echo '<span class="bundle-btn"><a href="'. esc_url( 'https://www.buywptemplates.com/products/wp-theme-bundle' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'THEME BUNDLE', 'vw-fitness-gym' ) .'</a></span>';
	echo '</div>';
}
...
function vw_fitness_gym_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Social Icon', 'vw-fitness-gym' ),
		'description'   => __( 'Appears on right side footer', 'vw-fitness-gym' ),
		'id'            => 'footer-icon',
...
function vw_fitness_gym_scripts() {
	...
	wp_enqueue_script( 'vw-fitness-gym-custom-scripts', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );

	if (get_theme_mod('vw_fitness_gym_animation', true) == true){
...
//Define
define('VW_FITNESS_GYM_FREE_THEME_DOC',__('https://demos.buywptemplates.com/demo/docs/free-fitness-gym/','vw-fitness-gym'));
define('VW_FITNESS_GYM_SUPPORT',__('https://wordpress.org/support/theme/vw-fitness-gym/','vw-fitness-gym'));
define('VW_FITNESS_GYM_PRO_SUPPORT',__('https://www.buywptemplates.com/pages/community','vw-fitness-gym'));
define('VW_FITNESS_GYM_REVIEW',__('https://wordpress.org/support/theme/vw-fitness-gym/reviews/','vw-fitness-gym'));
define('VW_FITNESS_GYM_BUY_NOW',__('https://www.buywptemplates.com/products/fitness-gym-wordpress-theme','vw-fitness-gym'));
define('VW_FITNESS_GYM_LIVE_DEMO',__('https://demos.buywptemplates.com/fitness-gym-pro/','vw-fitness-gym'));
define('VW_FITNESS_GYM_PRO_DOC',__('https://demos.buywptemplates.com/demo/docs/fitness-gym-pro/','vw-fitness-gym'));
...
define('VW_FITNESS_GYM_CREDIT',__('https://www.buywptemplates.com/products/free-gymming-wordpress-theme','vw-fitness-gym'));
define('VW_FITNESS_GYM_THEME_BUNDLE_BUY_NOW',__('https://www.buywptemplates.com/products/wp-theme-bundle','vw-fitness-gym'));
define('VW_FITNESS_GYM_THEME_BUNDLE_DOC',__('https://preview.vwthemesdemo.com/docs/theme-bundle/','vw-fitness-gym'));
...
if ( ! defined( 'VW_FITNESS_GYM_GETSTARTED_URL' ) ) {
	define( 'VW_FITNESS_GYM_GETSTARTED_URL', 'themes.php?page=vw_fitness_gym_guide');
}

if ( ! defined( 'VW_FITNESS_GYM_GO_PRO' ) ) {
	define( 'VW_FITNESS_GYM_GO_PRO', 'https://www.buywptemplates.com/products/fitness-gym-wordpress-theme');
}
...
function vw_fitness_gym_tagline_hide_show(){
	if(get_theme_mod('vw_fitness_gym_tagline_hide_show',0) == '1' ) {
		return true;
	}
	return false;
}
...
//Active Callback
function vw_fitness_gym_default_slider(){
	if(get_theme_mod('vw_fitness_gym_slider_type', 'Default slider') == 'Default slider' ) {
		return true;
	}
	return false;
}

function vw_fitness_gym_advance_slider(){
	if(get_theme_mod('vw_fitness_gym_slider_type', 'Default slider') == 'Advance slider' ) {
		return true;
	}
	return false;
}

function vw_fitness_gym_blog_post_featured_image_dimension(){
	if(get_theme_mod('vw_fitness_gym_blog_post_featured_image_dimension') == 'custom' ) {
		return true;
	}
	return false; 
}
...
if (!function_exists('vw_fitness_gym_edit_link')) :

    function vw_fitness_gym_edit_link($view = 'default')
    {
        global $post;
            edit_post_link(
                sprintf(
                    ...
                    /* translators: %s: Name of current post. Only visible to screen readers */
                        __('Edit <span class="screen-reader-text">%s</span>', 'vw-fitness-gym'),
                        array(
                            'span' => array(
                                'class' => array(),
                            ),
