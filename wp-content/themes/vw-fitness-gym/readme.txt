...
= 0.7.8 =
* Added go pro button in about and footer settings in customizer.
...
= 0.7.9 =
* Added condition for go pro button in function.php
...
* Resolved error for grid layout.
* Update language folder.  
...
* Added meta separator for grid layout in customizer.
* Added excerpt length for grid layout in customizer.
* Update pot file. 
...
* Resolved error for slider content.
* Resolved error for block pattern.

= 1.0.5 =
* Added background color option in about us section.
...
= 1.0.7 =
* Resolved menus css on hover.
* Added category and meta sidebar widgets for preview.
...
= 1.1.2 =
* Added css for cart page.
* Added css for view cart button on shop page.
* Added tagcloud css for preview sidebar.
* Added css for myaccount address button.
* Added myaccount address button in global color.
...
== Fonts ==
* Cabin *
* Source : https://fonts.google.com/specimen/Cabin?query=Cabin
...
== Theme Documentation ==
Documentation : https://demos.buywptemplates.com/demo/docs/free-fitness-gym/